    ...
    class CreateTest < MiniTest::Test
      ...
      def test_store_is_prompted
        CLI::UI::Prompt.expects(:ask)
          .with(@context.message('theme.forms.create.ask_store'))
      ...
      def test_password_is_prompted
        CLI::UI::Prompt.expects(:ask).with(@context.message('theme.forms.create.ask_password')).returns('boop')
        ask(password: nil)
      end
      ...
      def test_title_is_prompted
        CLI::UI::Prompt.expects(:ask).with(@context.message('theme.forms.create.ask_title')).returns('My Theme')
